import { BufferAttribute, BufferGeometry, Line, Mesh, MeshBasicMaterial, Plane, PlaneGeometry, Points, Vector3 } from "three";
import { TransformControls } from "three/examples/jsm/controls/TransformControls";
import Materials from "../Materials/Materials";
class Section {
    constructor(normal, position, max, min, camera, scene, renderer, callBack = null) {
